...
public class ViewAllActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		s1.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onNothingSelected(AdapterView<?> arg0) {
				Toast.makeText(getBaseContext(), "Please enter a sitename.",
	...
	/**
	 * 
	 * Method is called when View Or Edit Button is Pressed. id to be searched,
	 * username, master sent to next activity.
	 * 
	 * @param View
	 *            view
	 */
