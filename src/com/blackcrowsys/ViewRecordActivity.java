...
public class ViewRecordActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (getId() != 0) {
			...
			Toast.makeText(getBaseContext(),
					"There was a problem with the id number of this entry.",
	...
	/**
	 * Method called when user clicks 'Save Changes' button. Saves the changes
	 * made by a user to the entry using the id as the where clause.
	 */
	public void save(View view) {
		...
		boolean success = dbAdapter.updateSite(getId(), title, userName,
				password, getUsername(), URL, myComments, dbWrite);

		if (success) {
			Toast.makeText(getBaseContext(), "The entry has been updated.",
			...
			Toast.makeText(getBaseContext(),
					"The entry was not updated. Please try again.",
					Toast.LENGTH_SHORT).show();
		}
	}
	...
	/**
	 * @param EditText
	 * @return String in the EditText Returns the String value of the text
	 *         contained in an EditText widget.
	 */
